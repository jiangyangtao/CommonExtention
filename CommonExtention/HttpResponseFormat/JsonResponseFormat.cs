...
namespace CommonExtention.HttpResponseFormat
{
    ...
    public sealed class JsonResponseFormat : JsonFormatBase
    {
        ...
        /// </returns>
        public new JsonResult ResponseFail(string message = "Unknown error") => base.ResponseFail(message);
        ...
        /// Json格式 : {code:0,rows:data,total:1,message:Success}
        /// </returns>
        public new JsonResult ResponseGridResult<T>(T data, int count = 1) => base.ResponseGridResult(data, count);
        ...
        /// </returns>
        public new JsonResult ResponseGridResult(string message = "Unknown error") => base.ResponseGridResult(message);
